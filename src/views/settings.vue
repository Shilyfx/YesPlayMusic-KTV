  ...
  <div class="settings-page" @click="clickOutside">
    <div class="container">
      ...
      <div class="item">
        ...
        <div class="right">
          <div class="lyric-number-control">
            <button
              type="button"
              aria-label="减小歌词字号"
              title="减小歌词字号"
              @click="adjustLyricFontSize(-1)"
            >
              −
            </button>
            <input
              ...
              aria-label="歌词字号"
            />
            <output>{{ lyricFontSize }}px</output>
            <button
              type="button"
              aria-label="增大歌词字号"
              title="增大歌词字号"
      ...
      <div class="item">
        <div class="left">
          <div class="title">歌词同步</div>
          <div class="description">
            正数让歌词提前出现，负数让歌词延迟出现。
          </div>
        </div>
        <div class="right">
          <div class="lyric-number-control lyric-offset-control">
            <button
              type="button"
            ...
            <input
              v-model.number="lyricOffsetSeconds"
              type="range"
              min="-10"
              max="10"
              step="0.1"
            ...
            <button class="reset" type="button" @click="lyricOffsetSeconds = 0">
              归零
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    adjustLyricFontSize(amount) {
      this.lyricFontSize = Math.min(
        64,
        Math.max(16, Number(this.lyricFontSize) + amount)
      );
    },
    adjustLyricOffset(amount) {
      this.lyricOffsetSeconds = this.lyricOffsetSeconds + amount;
    },
    getAllOutputDevices() {
